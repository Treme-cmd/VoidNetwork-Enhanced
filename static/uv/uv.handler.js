(() => {
  var f = self.Ultraviolet,
      R = self.UVClient,
      I = self.__uv$config,
      c = self.__uv$bareData,
      d = self.__uv$bareURL,
      v = self.__uv$cookies;
  if (typeof c != "object" || typeof d != "string" || typeof v != "string")
    throw new TypeError("Unable to load global UV data");
  self.__uv || p(self);
  self.__uvHook = p;

  function p(o) {
    if ("__uv" in o && o.__uv instanceof f) return false;
    ...
    a.nativeMethods.defineProperty(o, "__uv", { value: e, enumerable: false });
    e.meta.origin = location.origin;
    e.location = a.location.emulate(
      t => t === "about:srcdoc" 
             ? new URL(t) 
             : (t.startsWith("blob:") && (t = t.slice(5)), new URL(e.sourceUrl(t))),
      t => e.rewriteUrl(t)
    );
    ...
    if (o.localStorage) {
      for (let t in o.localStorage) {
        if (t.startsWith(s + e.location.origin + "@")) {
          e.localStorageObj[t.slice((s + e.location.origin + "@").length)] = o.localStorage.getItem(t);
        }
      }
    ...
    if (o.sessionStorage) {
      for (let t in o.sessionStorage) {
        if (t.startsWith(s + e.location.origin + "@")) {
          e.sessionStorageObj[t.slice((s + e.location.origin + "@").length)] = o.sessionStorage.getItem(t);
        }
      }
    ...
    let m = o.document 
              ? a.node.baseURI.get.call(o.document)
              : o.location.href,
        P = e.sourceUrl(m);

    a.nativeMethods.defineProperty(e.meta, "base", {
      get() {
        if (!o.document) return e.meta.url.href;
        if (a.node.baseURI.get.call(o.document) !== m) {
          m = a.node.baseURI.get.call(o.document);
          P = e.sourceUrl(m);
        }
        return P;
      }
    ...
    a.on("wrap", (t, r) => {
      a.nativeMethods.defineProperty(r, "name", a.nativeMethods.getOwnPropertyDescriptor(t, "name"));
      a.nativeMethods.defineProperty(r, "length", a.nativeMethods.getOwnPropertyDescriptor(t, "length"));
    ...
    a.document.on("setCookie", t => {
      e.cookie.db().then(l => {
        ...
        e.cookie.getCookies(l).then(i => {
          n = e.cookie.serialize(i, e.meta, true);
        });
      });
      let r = e.cookie.setCookie(t.data.value)[0];
      r.path   || (r.path = "/");
      r.domain || (r.domain = e.meta.url.hostname);
      if (e.cookie.validateCookie(r, e.meta, true)) {
        n.length && (n += "; ");
        n += `${r.name}=${r.value}`;
      }
    ...
    a.element.on("getOuterHTML", t => {
      switch (t.that.tagName) {
        case "HEAD":
          t.data.value = e.sourceHtml(
            t.data.value.replace(/<head(.*)>(.*)<\/head>/s, "<op-head$1>$2</op-head>")
          ).replace(/<op-head(.*)>(.*)<\/op-head>/s, "<head$1>$2</head>");
          break;
        case "BODY":
          t.data.value = e.sourceHtml(
            t.data.value.replace(/<body(.*)>(.*)<\/body>/s, "<op-body$1>$2</op-body>")
    ...
    a.document.on("write", t => {
      if (!t.data.html.length) return false;
    ...
    a.element.on("getAttribute", t => {
      if (a.element.hasAttribute.call(t.that, e.attributePrefix + "-attr-" + t.data.name)) {
        t.respondWith(t.target.call(t.that, e.attributePrefix + "-attr-" + t.data.name));
      }
    });
    a.message.on("postMessage", t => {
      let r = t.data.origin, l = e.call;
      if (t.that) l = t.that.__uv$source.call;
      t.data.origin = "*";
      t.data.message = {
        __data: t.data.message,
      ...
      t.respondWith(
        b
          ...
          : l(t.target, [t.data.message, t.data.origin, t.data.transfer], t.that)
      );
    });
    a.message.on("data", t => {
      let { value: r } = t.data;
      if (typeof r == "object" && "__data" in r && "__origin" in r) {
        t.respondWith(r.__data);
      }
    });
    a.message.on("origin", t => {
      let r = a.message.messageData.get.call(t.that);
      if (typeof r == "object" && r.__data && r.__origin) {
    ...
    a.node.on("baseURI", t => {
      if (t.data.value.startsWith(o.location.origin)) {
        t.data.value = e.sourceUrl(t.data.value);
      }
    });

    a.element.on("setAttribute", t => {
      if (t.that instanceof h && t.data.name === "src" && t.data.value.startsWith("blob:")) {
        t.target.call(t.that, e.attributePrefix + "-attr-" + t.data.name, t.data.value);
        t.data.value = e.blobUrls.get(t.data.value);
        return;
      }
      if (e.attrs.isUrl(t.data.name)) {
        t.target.call(t.that, e.attributePrefix + "-attr-" + t.data.name, t.data.value);
        t.data.value = e.rewriteUrl(t.data.value);
      }
      if (e.attrs.isStyle(t.data.name)) {
        t.target.call(t.that, e.attributePrefix + "-attr-" + t.data.name, t.data.value);
        t.data.value = e.rewriteCSS(t.data.value, { context: "declarationList" });
      }
      if (e.attrs.isHtml(t.data.name)) {
        t.target.call(t.that, e.attributePrefix + "-attr-" + t.data.name, t.data.value);
        t.data.value = e.rewriteHtml(t.data.value, {
          ...e.meta,
          document: true,
      ...
      if (e.attrs.isSrcset(t.data.name)) {
        t.target.call(t.that, e.attributePrefix + "-attr-" + t.data.name, t.data.value);
        t.data.value = e.html.wrapSrcset(t.data.value.toString());
      }
      if (e.attrs.isForbidden(t.data.name)) {
    ...
    a.element.hookProperty([L, O, E, T], "href", {
    ...
    a.element.hookProperty([S, M, j, h, k, H, $, u, x, W], "src", {
      get: (t, r) => e.sourceUrl(t.call(r)),
      set: (t, r, [l]) => {
        if (new String(l).toString().trim().startsWith("blob:") && r instanceof h) {
          a.element.setAttribute.call(r, e.attributePrefix + "-attr-src", l);
          return t.call(r, e.blobUrls.get(l) || l);
        }
        a.element.setAttribute.call(r, e.attributePrefix + "-attr-src", l);
        t.call(r, e.rewriteUrl(l));
      }
    ...
    a.element.hookProperty([C], "action", {
      get: (t, r) => e.sourceUrl(t.call(r)),
      set: (t, r, [l]) => {
    ...
    a.element.hookProperty([k], "srcset", {
    ...
    let A = u && Object.getOwnPropertyDescriptor(u.prototype, "contentWindow").get;
    ...
    a.element.hookProperty(u, "srcdoc", {
      get: (t, r) =>
        a.element.getAttribute.call(r, e.attributePrefix + "-attr-srcdoc") || t.call(r),
      set: (t, r, [l]) => {
        t.call(
          r,
          e.rewriteHtml(l, {
    ...
    if ("serviceWorker" in o.navigator) {
    ...
    a.document.on("parseFromString", t => {
      if (t.data.type !== "text/html") return false;
      t.data.string = e.rewriteHtml(t.data.string, { ...e.meta, document: true });
    });

    a.attribute.on("getValue", t => {
      if (a.element.hasAttribute.call(t.that.ownerElement, e.attributePrefix + "-attr-" + t.data.name)) {
    ...
    a.attribute.on("setValue", t => {
      if (e.attrs.isUrl(t.data.name)) {
        a.element.setAttribute.call(t.that.ownerElement, e.attributePrefix + "-attr-" + t.data.name, t.data.value);
        t.data.value = e.rewriteUrl(t.data.value);
      }
      if (e.attrs.isStyle(t.data.name)) {
        a.element.setAttribute.call(t.that.ownerElement, e.attributePrefix + "-attr-" + t.data.name, t.data.value);
    ...
    a.storage.on("delete", t => {
      if (t.that.__uv$storageObj) {
        delete t.that.__uv$storageObj[t.data.name];
      }
      t.data.name = s + e.meta.url.origin + "@" + t.data.name;
    });
    ...
    a.storage.on("clear", t => {
      if (t.that.__uv$storageObj) {
        for (let r of a.nativeMethods.keys.call(null, t.that.__uv$storageObj)) {
          ...
          a.storage.removeItem.call(t.that, s + e.meta.url.origin + "@" + r);
          t.respondWith();
        }
      }
    });
    a.storage.on("length", t => {
      if (t.that.__uv$storageObj) {
        t.respondWith(a.nativeMethods.keys.call(null, t.that.__uv$storageObj).length);
      }
    });
    a.storage.on("key", t => {
      if (t.that.__uv$storageObj) {
        t.respondWith(a.nativeMethods.keys.call(null, t.that.__uv$storageObj)[t.data.index] || null);
      }
    });
    ...
    a.websocket.on("websocket", async t => {
      ...
      if (n !== "") r.Cookie = n.toString();
      t.respondWith(
        y.createWebSocket(t.data.args[0], t.data.args[1], {
          headers: r,
          readyStateHook: (l, i) => {
            l.__uv$getReadyState = i;
          },
          sendErrorHook: (l, i) => {
            l.__uv$getSendError = i;
          },
          urlHook: (l, i) => {
            l.__uv$socketUrl = i;
          },
          protocolHook: (l, i) => {
            l.__uv$getProtocol = i;
          },
          setCookiesCallback: l => {
            for (let i of l) o.document.cookie = i;
          },
          webSocketImpl: t.target
        })
      );
    });
    a.websocket.on("readyState", t => {
      if ("__uv$getReadyState" in t.that) {
    ...
    a.function.on("toString", t => {
      if (e.methods.string in t.that) {
        t.respondWith(t.that[e.methods.string]);
      }
    });
    ...
    a.style.on("setProperty", t => {
      if (a.style.dashedUrlProps.includes(t.data.property)) {
        t.data.value = e.rewriteCSS(t.data.value, { context: "value", ...e.meta });
      }
    });
    a.style.on("getPropertyValue", t => {
      if (a.style.dashedUrlProps.includes(t.data.property)) {
        t.respondWith(e.sourceCSS(t.target.call(t.that, t.data.property), {
          context: "value",
          ...e.meta
        }));
      }
    ...
    if ("CSS2Properties" in o) {
      for (let t of a.style.urlProps) {
        a.overrideDescriptor(o.CSS2Properties.prototype, t, {
          get: (r, l) => e.sourceCSS(r.call(l), { context: "value", ...e.meta }),
          set: (r, l, i) => {
            r.call(l, e.rewriteCSS(i, { context: "value", ...e.meta }));
          }
        });
      }
    } else if ("HTMLElement" in o) {
      a.overrideDescriptor(o.HTMLElement.prototype, "style", {
        get: (t, r) => {
          let l = t.call(r);
          if (!l[s + "modifiedStyle"]) {
            for (let i of a.style.urlProps) {
              a.nativeMethods.defineProperty(l, i, {
                enumerable: true,
                configurable: true,
                get() {
                  let g = a.style.getPropertyValue.call(this, i) || "";
                  return e.sourceCSS(g, { context: "value", ...e.meta });
                },
                set(g) {
                  a.style.setProperty.call(this, a.style.propToDashed[i] || i, e.rewriteCSS(g, {
                    context: "value",
                    ...e.meta
                  }));
                }
            ...
            a.nativeMethods.defineProperty(l, s + "modifiedStyle", {
              enumerable: false,
              value: true
            });
          }
    ...
    a.style.on("setCssText", t => {
      t.data.value = e.rewriteCSS(t.data.value, { context: "declarationList", ...e.meta });
    });
    a.style.on("getCssText", t => {
      t.data.value = e.sourceCSS(t.data.value, { context: "declarationList", ...e.meta });
    });

    // Hashchange override
    e.addEventListener.call(o, "hashchange", t => {
      if (t.__uv$dispatched) return false;
    ...
    a.location.on("hashchange", (t, r, l) => {
      if (l.HashChangeEvent && a.history.replaceState) {
        ...
        let i = new l.HashChangeEvent("hashchange", {
          newURL: r,
          oldURL: t
        });
        a.nativeMethods.defineProperty(i, s + "dispatched", {
          value: true,
          enumerable: false
        });
        e.dispatchEvent.call(o, i);
      }
    });
    ...
    e.$get = function(t) {
      return t === o.location ? e.location
           : t === o.eval     ? e.eval
           : t === o.parent   ? o.__uv$parent
           : t === o.top      ? o.__uv$top
           : t;
    };
    ...
    a.nativeMethods.defineProperty(o.Object.prototype, e.methods.setSource, {
      value: function(t) {
        if (a.nativeMethods.isExtensible(this)) {
    ...
    a.nativeMethods.defineProperty(o.Object.prototype, e.methods.location, {
      ...
      set(t) {
        if (this === o.document || this === o) e.location.href = t;
        else this.location = t;
      }
    });
  ...
  // ---------------------------------------------------------------------------
  // ADDITION: Try removing CSP/X-Frame from fetch responses (helps .io games).
  //           This is not standard Ultraviolet code but can help with
  //           Taming.io or other .io sites that enforce strict policies.
  // ---------------------------------------------------------------------------
  // We define an extra "response" hook. If your fork of Ultraviolet doesn't
  // support 'response' events on fetch, this code may be ignored.
  self.UVClient.prototype.fetch.on("response", t => {
    if (t?.data?.response?.headers && typeof t.data.response.headers.delete === "function") {
      t.data.response.headers.delete("Content-Security-Policy");
      t.data.response.headers.delete("X-Frame-Options");
    }
  });
