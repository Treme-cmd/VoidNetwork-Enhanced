...
},
{
    ...
    link: __uv$config.prefix + __uv$config.encodeUrl("https://www.hahagames.com/embed/chill-guy-clicker")
},
{
    title: "Escape Road", 
...
// these are added by the man of the hour TREME-CMD!!!!! :)
{
    title: "Time Shooter 3", 
    imgSrc: "https://raw.githubusercontent.com/Treme-cmd/TUGH/refs/heads/main/public/Assets/TS3.jpg",
    link: __uv$config.prefix + __uv$config.encodeUrl("https://tdataserver.netlify.app/gdata/vfmz/")
},
{
    title: "Minecraft", 
    imgSrc: "https://raw.githubusercontent.com/Treme-cmd/TUGH/refs/heads/main/public/Assets/MC.webp",
    link: __uv$config.prefix + __uv$config.encodeUrl("https://tdataserver.netlify.app/gdata/z2ftzxm=/mc.html")
},
{
    title: "Obby On A Bike", 
    imgSrc: "https://raw.githubusercontent.com/Treme-cmd/TUGH/refs/heads/main/public/Assets/ONAB.png",
    link: __uv$config.prefix + __uv$config.encodeUrl("https://tdataserver.netlify.app/gdata/z2ftzxm=/onab")
},
{
    title: "Super Mario 64", 
    imgSrc: "https://raw.githubusercontent.com/Treme-cmd/TUGH/refs/heads/main/public/Assets/SM64.png",
    link: __uv$config.prefix + __uv$config.encodeUrl("https://tdataserver.netlify.app/gdata/z2ftzxm=/sm64.html")
},
// wait a minute... Why are all the games from one source? OH THAT'S RIGHT, IT'S TREME-CMD'S AWESOME OTHER WEBSITE!!! (that sadly doesnt have Ultraviolet :c) - P.S. the link is projectsbytreme.neocities.org :) Anyway, enough glazing myself
{
    title: "Brotato", 
    imgSrc: "https://play-lh.googleusercontent.com/Nd86kP1molGyKwoD5ROMMGTkmTVKNvfosdW4VhjO52IIZaLHZSxF1Eygu5OOMvH-xyY",
    link: __uv$config.prefix + __uv$config.encodeUrl("https://tdataserver.netlify.app/gdata/qnjvdgf0bw==/")
},
   ];
